...
Function SendSessionEvent(String asPath) Global
	...
	If iHandle
		...
		Debug.Trace("vSS/Session: Sent SessionEvent: " + asPath)
	Else
		Debug.Trace("vSS/Session: Could not send vSS_SessionUpdate!")
	EndIf
EndFunction
...
Int Function CreateSessionDataIfMissing() Global
	...
	JMap.setObj(_jvSS,"Session",jSessionData)
	Return jSessionData
EndFunction

Function SetSessionID(String asNewSID) Global
	JDB.SolveStrSetter(".vSS.Session.SessionID",asNewSID,True)
EndFunction
...
String Function GetSessionStr(String asPath, Bool abUseDefault = False) Global
	If abUseDefault 
		If !JDB.HasPath(".vSS.Session." + asPath)
			Return GetRegStr(asPath)
		EndIf
	EndIf
	Return JDB.solveStr(".vSS.Session." + asPath)
EndFunction
...
Bool Function GetSessionBool(String asPath, Bool abUseDefault = False) Global
	If abUseDefault 
		...
		EndIf
	EndIf
	Return JDB.solveInt(".vSS.Session." + asPath) as Bool
EndFunction
...
Int Function GetSessionInt(String asPath, Bool abUseDefault = False) Global
	If abUseDefault 
		...
		EndIf
	EndIf
	Return JDB.solveInt(".vSS.Session." + asPath)
EndFunction
...
Float Function GetSessionFlt(String asPath, Bool abUseDefault = False) Global
	If abUseDefault 
		...
		EndIf
	EndIf
	Return JDB.solveFlt(".vSS.Session." + asPath)
EndFunction
...
Form Function GetSessionForm(String asPath, Bool abUseDefault = False) Global
	If abUseDefault 
		...
		EndIf
	EndIf
	Return JDB.solveForm(".vSS.Session." + asPath)
EndFunction
...
Int Function GetSessionObj(String asPath, Bool abUseDefault = False) Global
	If abUseDefault 
		...
		EndIf
	EndIf
	Return JDB.solveObj(".vSS.Session." + asPath)
EndFunction
